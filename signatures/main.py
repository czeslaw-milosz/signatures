...
@click.option("--num_topics", default=14, help="Number of topics to discover.")
...
@click.option("--kl_weight", default=1.0, help="Weight of the KL divergence term in the variational loss.")
@click.option("--nll_weight", default=1.0, help="Weight of the NLL term in the variational loss.")
